...
const ShoppingCart: React.FC = () => {
  ...
  // CHANGED: Added your loading state for a better UX
  if (loading) {
    return (
  ...
  // This "Empty Cart" view was already correct
  if (cartItems.length === 0) {
    return (
  ...
  // This is the full view with the sidebar included
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg font-semibold text-gray-900">
                          {/* CHANGED: Use nested product price for calculation */}
          ...
          {/* -------------------------------------------------- */}
          {/* FIXED: This is the Order Summary sidebar you were missing */}
          {/* -------------------------------------------------- */}
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              ...
              {discount > 0 && (
                <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-sm text-green-800">
                    🎉 You saved ${discount} on orders over $200!
                  </p>
                </div>
              )}
              ...
              <Link
                to="/products"
                className="block w-full mt-3 text-center py-2 px-4 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors"
              >
                Continue Shopping
              </Link>
            </div>

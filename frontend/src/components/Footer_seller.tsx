...
export default function Footer_seller() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">Empowering sellers to grow their business online with powerful tools and insights.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span>sellers@sellerhub.com</span>
              </li>
              <li className="flex items-center gap-2">
